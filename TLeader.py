...
def TLeader():
    ...
    Label(frame, text="Team Leader DASHBOARD", fg="red", bg="#76EE00", font=("Microsoft YaHei UI Light", "20")).place(x=350,
                                                                                                              y=5)
    ...
    Teams = Button(root, text="Employee", width=20, bg="#76EE00", fg="blue", bd=0,
                               font=("Microsoft YaHei UI Light", "16"), command=Teams)
    Teams.place(x=100, y=200)
    root.mainloop()
